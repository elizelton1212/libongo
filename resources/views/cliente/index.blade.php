...
<div id="teste">
    ...
    <button type="submit" class="btn btn-primary" name="salvar" id="salvar-cliente">Salvar</button>
 ...
 <button class="btn btn-primary" id="cadastraCliente"  data-toggle="modal" data-target="#modal-cliente">
 ...
 <tbody>      
    ...
    <td>{{$f->nif}}</td>
    <td>
    <a href="{{url("cliente/$f->id")}}" class='show-modal btn btn-info btn-sm'>
    <i class="fas fa-eye"></i>
    </a>
    <a href="{{url("cliente/$f->id/edit")}}" class="edit-modal btn btn-warning btn-sm" data-id="{{$f->id}}" data-nome="{{$f->nome}}" data-nacionalidade="{{$f->nacionalidade}}" data-telefone="{{$f->telefone}}" data-email="{{$f->email}}">
    <i class="fas fa-pencil-alt"></i>
    </a>
   <a href="{{url('cliente/$f->id')}}" class="delete-modal btn btn-danger btn-sm" data-id="{{$f->id}}" data-nome="{{$f->nome}}" data-nacionalidade="{{$f->nacionalidade}}" data-telefone="{{$f->telefone}}" data-email="{{$f->email}}">
